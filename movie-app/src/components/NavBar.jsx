...
const NavBar = () => {
  ...
  return (
    <div ref={scroll} className='bg-[#222831] w-dvw  max-md:text-md flex items-center text-white place-content-between p-4 font-megrim font-bold uppercase'>
      ...
      <form action="" onSubmit={(e)=>handleSearch(e)}>
        <input type="text" className='w-full rounded-xl scale-[0.8] animate bg-[#222831] border text-center hover:scale-[1] hover:border-[#00ADB5] animate  hover:shadow-[#95eaef83]  hover:shadow-md ' placeholder='Search' name="" id="" value={search} onChange={(e)=>setSearch(e.target.value)} />
      </form>
      </div>
